...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    <div class="contenedor_general">
        ...
        <div class="row datosPersonales">
            ...
            <div class="col-md-10">
                <asp:TextBox ID="txt_pnombre" runat="server" placeholder="Ej: Jhonny" onchange="concatenarNombres();" required ></asp:TextBox>
            </div>
        </div>
        <div class="row datosPersonales">
            <div class="col-md-2">
        ...
        <div class="row datosPersonales">
            ...
            <div class="col-md-10">
                <asp:TextBox ID="txt_papellido" runat="server" placeholder="Ej: Mejía" onchange="concatenarNombres();" required ></asp:TextBox>
            </div>
        </div>
        <div class="row datosPersonales">
            <div class="col-md-2">
